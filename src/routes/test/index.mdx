...
This route tests if there is currently an issue where Qwik is rendering MDX. In Qwik UI, there is an issue when the user refreshes in preview build, and the autocomplete is broken inside of MDX.
